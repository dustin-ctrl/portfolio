...
export const PROJECTS_DATA: AppProject[] = [
{
  ...
  },
  {
    ...
    platform: "Web",
    status: "OFFLINE",
    githubUrl: "https://github.com/yourusername/musubi-ichi",
    title: "生産者直結プラットフォーム「結び市」（夏季インターン成果物）",
    year: "2025",
    role: "夏季インターンシップ（Sole Developer / UI・UX設計・実装）",
    tech: ["ServiceNow", "App Engine", "Flow Designer"],
    comments: ["インターン成果物", "UI_UX最高評価", "Sole_Developer"],
    ...
    highlight: "「デザインの力で社会課題のハードルを下げる」という、自身のフロントエンド・アイデンティティの確信に繋がったプロジェクトです。",
  ...
  },
  {
    ...
    title: "Reception now ~民泊向けホテル受付業務~",
    year: "2025",
    role: "ハッカソン",
  ...
  },
  {
    ...
    title: "サブスクリプション管理アプリ（ハッカソン広島大会 優勝）",
    year: "2024",
    role: "学部4年ハッカソン（モバイルアプリ実装）",
    tech: ["Kotlin", "Android Studio", "SQLite"],
    comments: ["初ハッカソン", "広島大会優勝", "エンジニアの原点"],
    overview: "初めて出場したハッカソンで、現代の不透明な固定費を可視化・最適化するために実装したネイティブアプリケーションです。",
    problem: "課題感の鋭さと目の付け所が圧倒的に評価され、初出場にして「ハッカソン広島大会優勝」という快挙を達成。しかし、一方で時間内の実装が完全ではなく、全国大会への切符を逃すという、エンジニア人生で最も強烈な「悔しさ」を味わった原点のアプリです。",
