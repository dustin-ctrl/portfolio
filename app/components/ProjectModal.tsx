        ...
        >
          ...
          <div className="space-y-6 w-full">
            ...
            <div className="border-b-4 border-black pb-5 mt-2 sm:mt-0 pr-12 sm:pr-0">
              ...
              {/* 💡 変更点: タイトルとボタンを横一列（右端）に並べるフレックスコンテナを新設 */}
              ...
              {/* プロジェクト概要説明（見た目の連続性を損なわないためにタイトルの下に配置） */}
              <p className="text-xs sm:text-sm lg:text-base font-bold text-slate-700 leading-snug bg-slate-50 border-l-4 border-black p-3 rounded-r-lg mt-4">{project.overview}</p>
